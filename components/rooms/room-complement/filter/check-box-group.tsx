  ...
  return (
    <>
      {options && options.length > 0 && (
        ...
        >
          <div className="h-[28rem]  px-14 md:px-14 pt-[1.7rem] md:pt-[1.7rem] pb-[2rem] md:pb-[2rem] bg-platinum rounded-[0.8rem] rounded-b-[0.5rem] sm:px-[3.5rem] sm:pb-[8rem] sm:m-0 sm:h-full">
